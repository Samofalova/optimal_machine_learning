import unittest
from gradient import GDSteepest
import numpy as np

class TestGDSteepest(unittest.TestCase):
    ...
    def test_6(self):
        ...
        res = GDSteepest(f, pf, dataset_rec=1, accuracy=10 ** (-5))
        value_f = res['interim_results_dataset']['f'].iloc[-1]
        self.assertAlmostEqual(value_f, 0, places=0)
