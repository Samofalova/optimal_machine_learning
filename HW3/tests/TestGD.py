...
class TestGD(unittest.TestCase):
    ...
    def test_3(self):
        ...
        res = GD(f, pf, lr_rate=0.05, dataset_rec=1, accuracy=10 ** (-10))
        value_f = res['interim_results_dataset']['f'].iloc[-1]
        self.assertAlmostEqual(value_f, 0, places=0)
    ...
    def test_6(self):
        ...
        res = GD(f, pf, lr_rate=0.01, dataset_rec=1, accuracy=10 ** (-5))
        value_f = res['interim_results_dataset']['f'].iloc[-1]
        self.assertAlmostEqual(value_f, 0, places=0)
    ...
    def test_7(self):
        ...
        res = GD(f, pf, lr_rate=0.01, dataset_rec=1, accuracy=10 ** (-10))
        value_f = res['interim_results_dataset']['f'].iloc[-1]
        self.assertAlmostEqual(value_f, 0, places=0)
    ...
    def test_9(self):
        ...
        res = GD(f, pf, lr_rate=0.5, dataset_rec=1, accuracy=10**(-10))
        value_f = res['interim_results_dataset']['f'].iloc[-1]
        self.assertAlmostEqual(value_f, 0, places=0)
    ...
    def test_10(self):
        ...
        res = GD(f, pf, lr_rate=0.1, dataset_rec=1, accuracy=10 ** (-10))
        value_f = res['interim_results_dataset']['f'].iloc[-1]
